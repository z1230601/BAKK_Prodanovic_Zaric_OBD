...
class DBExecuter
{
    public:
        ...
        SQLTable readData(std::string table, std::vector<std::string> columns,
                std::string condition);
        bool insertData(std::string to_table, std::vector<std::string> columns,
                SQLTable data);
        void deleteData(std::string table, std::vector<std::string> columns,

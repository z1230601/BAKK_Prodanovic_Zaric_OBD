...
\newcommand{\mytitle}{Software Development Techniques in the Automotive Context}  %% also used for PDF metadata (hyperref)
\newcommand{\mysubject}{A practical analysis using On Board Diagnosis}  %% also used for PDF metadata (hyperref)
...
\newcommand{\mysupervisor}{Dr. Harald Sporer} %% your supervisor
...
% TODO: link bibliography too wide

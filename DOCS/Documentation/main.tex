...
\newcommand{\mytitle}{Software Development Techniques in the Automotive Context - A practical Example using On Board Diagnosis}  %% also used for PDF metadata (hyperref)

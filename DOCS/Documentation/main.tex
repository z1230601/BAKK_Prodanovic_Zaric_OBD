...
%% general metadata:
\newcommand{\myauthor}{Zoran Prodanovic, Zlatan Zaric}  %% also used for PDF metadata (hyperref)
\newcommand{\mytitle}{Incorporation of Agile Software Development and Automotive Software Development - A practical Example using On Board Diagnosis}  %% also used for PDF metadata (hyperref)
...
\newcommand{\myinstitutehead}{Univ.-Prof.\,Dipl.-Inform.\,Dr.sc.ETH Kay R\"omer} %% head of institute
\newcommand{\mysupervisor}{Ao.\,Univ.-Prof.\,Dipl-Ing.\,Dr.techn. Eugen Brenner, Dipl-Ing.\,Dr.techn. Harald Sporer} %% your supervisor
...
% TODO: interface descriptor / endpoint descriptor tables placement & pic placement
...
\input{chapters/OBDBasics}
\input{chapters/Implementation}
\input{chapters/Projectspecific}
\input{chapters/SoftwareDevelopmentTechniques}

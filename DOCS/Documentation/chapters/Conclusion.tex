...
\myfigref{fig:implemented_req} shows the achieved goals.

\myfig{Requirements-Implemented_Software_Requirements}%% filename w/o extension in the folder figures
 {width=\textwidth}%% maximum width/height, aspect ratio will be kept
 {Implemented Software Requirements}%% caption
 {Figure}%% optional (short) caption for list of figures
 {fig:implemented_req}%% label

\section{Outlook}
\label{sec:outlook}

The thesis started with the intention of researching and implementing the OBD technology, as explained in \nameref{sec:motivation}. After consulting 

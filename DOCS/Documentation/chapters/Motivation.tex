...
%As our research revealed the OBD interface has direct access to the diagnostic control unit and 
%therefore to each bus used in the automobile. This issue was one of the most important disadvantages critics discussed since the introduction of OBD.

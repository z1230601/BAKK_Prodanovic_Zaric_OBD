...
from USB over Bluetooth to Wi-Fi or even RS-232.\footcite[p. 46 ff.]{SCHAFOBD2}
...
USB is used for a vast range of devices. Due to the project requirements for the selection and communication to as well as the emulation of an USB device,
...
\end{tabular}
\caption{Device Descriptor Fields\footcite[p. 262\-263]{USB}}
\end{table}
...
\end{tabular}
 \caption{Configuration Descriptor Fields\footcite[p. 265\-266]{USB}}
\end{table}
...
\end{tabular}
 \caption{Interface Descriptor Fields\footcite[p. 268\-269]{USB}}
\end{table}
...
\end{tabular}
 \caption{Endpoint Descriptor Fields\footcite[p. 269\-271]{USB}}
\end{table}
...
\end{tabular}
 \caption{String Descriptor Main Fields\footcite[p. 273\-274]{USB}}
\end{table}
...
\end{tabular}
 \caption{String Descriptor Language Fields\footcite[p. 273]{USB}}
\end{table}
...
\end{tabular}
 \caption{String Descriptor Fields\footcite[p. 274]{USB}}
\end{table}

...
introduces those basics gathered from the website \citetitle{USBNUT}\cite{USBNUT}, which summarizes the official \citetitle{USB} 
...
\myfig{usb_topology}%% filename w/o extension in the folder figures
 ...
 {Waterfall Development Process}%% optional (short) caption for list of figures
 {fig:waterfall}%% label
